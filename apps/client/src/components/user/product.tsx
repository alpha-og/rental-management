...
const ProductCard: React.FC<ProductCardProps> = ({ product }) => {
    return (
        <Link href={`/user/product/${product.id}`}>
            <div className="bg-white rounded-lg shadow-sm border border-slate-200 p-6 hover:shadow-md transition-all duration-200 hover:-translate-y-1 cursor-pointer">
